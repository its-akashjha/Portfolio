          ...
          <div className="w-[80%] h-screen overflow-scroll absolute top-0 left-0 bg-gray-900 p-4 scrollbar-hide">
            <div className="flex flex-col gap-8 py-2 relative">
              <div>
                ...
                Software developer skilled in building scalable web apps with expertise in React, Node.js, and Firebase, and a strong foundation in competitive programming.                </p>
              </div>
